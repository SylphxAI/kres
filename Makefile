...
#
# Generated on 2026-08-05T06:47:23Z by kres undefined.
...
helm-plugin-install:  ## Install pinned helm plugins
	@set -e; \
	...
	helm plugin install https://github.com/losisin/helm-values-schema-json.git --version=v2.5.0
